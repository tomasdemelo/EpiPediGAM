...
surrogate type multivariate, N = 1000, seed 1867
...
multivariate_ensemble_statistic.csv, which is dependence-preserving.

Resolution floor: no p below 1/(N+1) = 0.00100 can be claimed.
