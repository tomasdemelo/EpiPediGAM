...
The main script (GAM_MCS.rmd) generates the optimal GAM model by accounting for temporal offsets between the datasets. After which, suitable models are subjected to a stochastic simulation where Gaussian noise is added incremently to asses model robustness.
